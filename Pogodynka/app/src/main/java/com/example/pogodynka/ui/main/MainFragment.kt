...
class MainFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Switch>(R.id.changeViewSwitch).isChecked = true
        ...
        view.findViewById<Switch>(R.id.changeViewSwitch).apply {
            setOnClickListener {
                view.findNavController().navigate(R.id.action_mainFragment_to_simplerFragment)
            }
        }
    }
    ...
    private fun refreshValue(townName: String, view: View) {
        ...
        view.findViewById<TextView>(R.id.dateValue).text = LocalDateTime.now().format(DateTimeFormatter.ofPattern("dd-MM-yyyy hh:mm"))
